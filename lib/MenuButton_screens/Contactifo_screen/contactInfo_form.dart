                ...
                itemBuilder: (context, index) {
                  return Dismissible(
                    ...
                    onDismissed: (direction) {
                      // deleteAddress(snapshot.data[index].id);
                    },
                    child: Card(
                      child: ListTile(
  ...
  Widget addressList() {
    return FutureBuilder<List<Address>>(
        ...
        builder: (context, snapshot) {
          ...
          //       mainAxisAlignment: MainAxisAlignment.center,
          //       children: <Widget>[
          //         Text(snapshot.data?.toString() ?? "Deleted"),
          //         ElevatedButton(
          //           onPressed: () {
          //             setState(() {
          //               _futureAddress =
          //                   deleteAddress(snapshot.data.id.toString());
          //             });
          //           },
                ...
                itemBuilder: (context, index) {
                  return Dismissible(
                    ...
                    onDismissed: (direction) {
                      setState(() {
                        _futureAddress =
                            deleteAddress(snapshot.data[index].id.toString());
                      });
                    },
                    child: Card(
                      child: ListTile(
